	...
	return (
		<>
			<div className="z-[10] flex flex-col justify-center align-center items-center absolute   w-full md:my-24">
				<h2 className="mx-4 md:my-12 md:text-5xl text-center mb-5 font-semibold text-3xl md:text-4xl text-white">
				...
				<p className="text-center text-md text-white md:text-lg md:mx-12">
				...
				<button className="transition ease-in-out duration-150 mt-4 flex justify-center align-center text-white focus:bg-gray-500 px-4 py-2 text-center rounded-2xl border border-white hover:bg-gray-500 md:mt-12">
					Plan your visit
				</button>
			</div>
			<img
